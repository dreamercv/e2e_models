...
__all__ = ['TrajectoryVQVAE', 'TrajectoryEncoder', 'TrajectoryDecoder']
...
class TrajectoryVQVAE(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = TrajectoryEncoder(traj_dim=traj_dim, e_dim=e_dim, hidden=enc_hidden)
        self.decoder = TrajectoryDecoder(traj_dim=traj_dim, e_dim=e_dim, hidden=dec_hidden)
